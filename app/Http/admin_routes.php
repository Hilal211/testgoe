...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => ['hasrole:admin']], function () {
    ...
    Route::post('/save-statorder', ['as' => 'save.statorder', 'uses' => 'OrderController@statOrder']);

    /*----------  statOrder pages  ----------*/
    Route::get('/statorderstore', ['as' => 'admin.get.statorderstore', 'uses' => 'OrderStoreDetailsController@index']);
    Route::post('/save-statorderstore', ['as' => 'save.statorderstore', 'uses' => 'OrderStoreDetailsController@statOrderstore']);
