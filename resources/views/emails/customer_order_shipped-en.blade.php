...
<body>
    <div style="width:600px; border:15px #88c000 solid;margin:0 auto;font-family: sans-serif; color: #000AAA; display: table;">
        <table border="0" cellspacing="0" style="font-size: 14px;float: left;width: 100%;">
            ...
            <tr>
                <td colspan="2" style="padding:10px;color:#666666"><b>Hello {{$user->firstname}}</b></td>
            </tr>
            <tr>
                <td colspan="2" style="padding:10px;color:#666666">
                    Your order {{$order->order_number}}, is on its way for delivery, please make sure someone is home to receive it.
            ...
            <tr>
                <td colspan="2" style="padding:10px;color:#666666"><br/>Team Goecolo</td>
            </tr>
            <tr>
