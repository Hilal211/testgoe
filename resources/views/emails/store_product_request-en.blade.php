...
<body>
    <div style="width:600px; border:15px #88c000 solid;margin:0 auto;font-family: sans-serif; color: #000AAA; display: table;">
        <table border="0" cellspacing="0" style="font-size: 14px;float: left;width: 100%;">
            ...
            <tr>
                <td colspan="2" style="padding:10px;color:#666666"><b>Hello {{$store->storename}},</b></td>
            </tr>
            <tr>
                <td colspan="2" style="padding:10px;color:#666666">
                   Thank you for contacting us,we received your product request and will do the necessary to add it to your store pricelist and make it available for online shopping within 24 hours. <br> <br>
