...
<body>
    <div style="width:600px; border:15px #88c000 solid;margin:0 auto;font-family: sans-serif; color: #000AAA; display: table;">
        <table border="0" cellspacing="0" style="font-size: 14px;float: left;width: 100%;">
            ...
            <tr>
                <td colspan="2" style="padding:10px;color:#666666"><b>Bonjour {{$user->firstname}}</b></td>
            </tr>
            <tr>
                <td colspan="2" style="padding:10px;color:#666666">
                     Votre commande {{$order->order_number}},  est en cours de livraison, veuillez vous assurer que quelqu'un est à la maison pour la recevoir.

                     <br>Merci pour vos achats avec nous
                     <br>A bientôt!
                </td>
            </tr>
            <tr>
                <td colspan="2" style="padding:10px;color:#666666"><br/>Équipe GoEcolo</td>
            </tr>
            <tr>
