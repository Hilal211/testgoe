        ...
        <table border="0" cellspacing="0" style="font-size: 14px;float: left;width: 100%;">
            ...
            <tr>
                <td colspan="2" style="padding:10px;color:#666666">
                    Welcome to Goecolo, we will get you started with us, we just need to do some back office work, You will receive a confirmation email within 48 hours, Do keep an eye on your mail (maybe spam mail too) <br/><br/>
