        ...
        <table border="0" cellspacing="0" style="font-size: 14px;float: left;width: 100%;">
            ...
            <tr>
                <td colspan="2" style="padding:10px;color:#666666">
                    Voici votre nouveau mot de passe basé sur votre demande de réinitialisation de mot de passe - <Br>
                    {{$password}}
                    <Br><br>
                        Veuillez modifier le mot de passe temporaire immédiatement après vous être connecté à votre profil.
                </td>
            </tr>
            <tr>
