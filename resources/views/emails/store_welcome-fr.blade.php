        ...
        <table border="0" cellspacing="0" style="font-size: 14px;float: left;width: 100%;">
            ...
            <tr>
                <td colspan="2" style="padding:10px;color:#666666">
                    Bienvenue à Goecolo, nous vous aiderons à commencer avec nous, nous avons juste besoin de faire quelques travaux de back office, vous recevrez un email de confirmation dans les 48 heures, ne gardez un œil sur votre courrier (peut-être spam courrier trop) <br/><br/>
