        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="box-tools pull-right">
              <a href="#ProductModal" data-toggle="modal" class="btn btn-primary"><i class="fa fa-plus"></i></a>
            </div>
          </div>
          <div class="box-body">
            <div class="table-responsive">
              <table id="ProductTable" class="table no-margin table-small-padding table-actions orderTable">
                <thead>
                  <tr>
                    <th>Product Name</th>
                    <th>Note</th>
...
<script>
  ...
  $(document).ready(function(){
    oTable = $('#ProductTable').DataTable({
      processing: true,
      serverSide: true,
      ajax: '{{route('store-requested-product-data')}}',
      order: [['0','desc']],
  ...
  function SetEdit(element){
    ...
    $.ajax({
      type: "POST",
      url: APP_URL+'/store/requested-product/'+Id,
      data: "",
      dataType: "json",
      success: function(res) {
        Modal.modal('show');
