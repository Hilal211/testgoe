  ...
  $(document).ready(function(){
    oTable = $('#All_OrderTable').DataTable({
      ...
      columns: [
            ...
            {data: '1', name: 'total_items',searchable:false},
            {data: '2', name: 'users.username'},
            {data: '3', name: 'orders.created_at'},
            {data: '4', name: 'orders.grand_total'},
            {data: '5', name: 'orders.status'}
        ]
    });
  })
