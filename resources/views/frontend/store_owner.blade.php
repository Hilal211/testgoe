...
<div class="container">
    ...
    <div class="row bg-orange-rounded">
        <div id="form-container" class="col-md-12 no-padding">
            ...
            <div class="col-md-8 col-md-push-2">
                ...
                {!! Form::close() !!}
                @endif
                <div class="limited-access-holder row display-none">
                    <div class="col-md-12">
...
<script type="text/javascript">
var Limitedmsg ='{{trans("keywords.Currently we are serving only Montreal area, Please insert below details, We'll inform you when we provide services in your city.")}}';
