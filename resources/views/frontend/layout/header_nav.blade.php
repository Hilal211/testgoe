    ...
    <div class="collapse navbar-collapse" id="main-nav-collapse">
        <div class="">
            ...
            <ul class="nav navbar-nav navbar-center">
                        ...
                        <li class="yamm-content">
                            <div class="row -row-eq-height row-col-border">
                                <ul class="dropdown-menu-items-list">
                                    ...
                                    {{-- <li><a href="{{route("pages.settings",[App::getLocale(),\Crypt::encrypt(Auth::user()->id)])}}">{{trans('keywords.Settings')}}</a></li> --}}
                ...
                <li class="dropdown -yamm-fw check-cart-icon"><a href="javascript:void(0)" onclick="reloadCartItem();"><span><i class="fa fa-shopping-cart" aria-hidden="true"></i></span><div id="total-cart-items">Cart </div></a></li>
